...
// v15e: shelf metadata getters + setters.
const QString& LibraryShelf::color() const { return m_color; }
bool LibraryShelf::favorite() const { return m_favorite; }
bool LibraryShelf::isPrivate() const { return m_isPrivate; }
int LibraryShelf::sortOrder() const { return m_sortOrder; }

void LibraryShelf::setColor(const QString& color) {
    if (m_color != color) {
        m_color = color;
        emit shelfChanged();
    }
...
void LibraryShelf::setFavorite(bool favorite) {
...
void LibraryShelf::setIsPrivate(bool isPrivate) {
...
void LibraryShelf::setSortOrder(int order) {
