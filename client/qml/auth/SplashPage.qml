...
Item {
    ...
    Column {
        ...
        BrandLogo {
            ...
            // BUG FIX (Issue 21): the SequentialAnimation was missing
            // `running: true`. QML animations default to `running: false`
            // unless explicitly started, so the intended "gentle pulse"
            // of the brand mark on the splash screen was silent.
            SequentialAnimation {
                running: true
