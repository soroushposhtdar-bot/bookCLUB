            ...
            Item {
                ...
                AppIcon {
                    ...
                    SequentialAnimation {
                        ...
                        // BUG FIX: `target: parent` referenced the
                        // SequentialAnimation (which has no `scale` property),
                        // so the icon stayed at scale 0.0 forever and was
                        // invisible. Now targets `_checkIcon` explicitly.
                        NumberAnimation { target: _checkIcon; property: "scale"; from: 0.0; to: 1.0; duration: Theme.motion.durationBase; easing.type: Easing.OutBack }
                    }
                }
            }
