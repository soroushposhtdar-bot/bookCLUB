...
Item {
    ...
    Column {
        ...
        Column {
            ...
            // v10: Settings NavItem removed — the project doesn't need a
            // separate settings page. Profile page now includes theme toggle
            // + sign out in a clean "Account" section.
            NavItem {
                width: parent.width
                iconName: "logout"
                label: "Sign out"
