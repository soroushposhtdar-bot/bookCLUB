...
Popup {
    ...
    property var confirmedCb: null
    property var cancelledCb: null
    ...
    function openDialog(cfg) {
        ...
        if (cfg.confirmedCb)  root.confirmedCb = cfg.confirmedCb
        if (cfg.cancelledCb)  root.cancelledCb = cfg.cancelledCb
        open()
    }
    ...
    Column {
        ...
        Row {
            ...
            PrimaryButton {
                ...
                onClicked: {
                    root.confirmed()
                    if (root.confirmedCb) root.confirmedCb()
                    root.close()
                }
            }
            SecondaryButton {
                ...
                onClicked: {
                    root.cancelled()
                    if (root.cancelledCb) root.cancelledCb()
                    root.close()
                }
            }
        }
