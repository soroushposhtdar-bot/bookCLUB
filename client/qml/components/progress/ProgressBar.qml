...
Item {
    ...
    property color trackColor: Qt.rgba(Theme.color.textMuted.r, Theme.color.textMuted.g, Theme.color.textMuted.b, 0.20)
    ...
    SequentialAnimation {
        ...
        ParallelAnimation {
            ...
            NumberAnimation { target: _fill; property: "opacity"; from: 0.0; to: 1.0; duration: Theme.motion.durationBase }
        }
        NumberAnimation { target: _fill; property: "opacity"; to: 0.0; duration: Theme.motion.durationBase }
    }
}
