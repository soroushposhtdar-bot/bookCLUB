...
Item {
    ...
    // v15f: when false, the price column is hidden. Used by the Shelves
    // page detail panel — books in a shelf shouldn't show their price
    // since the user already owns or is just organizing them.
    ...
    Row {
        ...
        // Info column
        // v15f: width adapts to whether price + actions are shown.
        Column {
            width: parent.width - 56 - Theme.space.md
                  - (root.showPrice ? _priceCol.width + Theme.space.md : 0)
                  - (root.showActions ? _actions.width + Theme.space.md : 0)
            spacing: 2
            anchors.verticalCenter: parent.verticalCenter
        ...
        // Price column — v15f: hidden when showPrice is false.
        Column {
            id: _priceCol
            width: 90
            spacing: 0
