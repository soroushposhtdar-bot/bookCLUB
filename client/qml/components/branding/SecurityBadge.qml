...
Item {
    ...
    Rectangle {
        ...
        anchors.fill: parent
        radius: height / 2
        // BUG FIX: previously used textOnAccent (white) at 85% opacity —
        // invisible on the white/light-gray hero panel. Now uses a tinted
        // accent background so the badge is visible.
