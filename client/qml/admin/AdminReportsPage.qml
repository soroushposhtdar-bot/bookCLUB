...
//     so the report list re-syncs whenever the VM pushes data
//   - Added _delayedRefresh Timer to re-sync after async VM.refresh() completes
//   - Defensive null/undefined checks in _refreshFromVM
...
Item {
    ...
    Connections {
        ...
        function onReportsChanged() { page._refreshFromVM() }
    ...
    Timer {
        ...
        onTriggered: {
            if (page.viewModel && page.viewModel.reports && page.viewModel.reports.length > 0) {
                page._refreshFromVM()
        ...
        ColumnLayout {
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Column {
                        ...
                        Text {
                            text: "Triage incoming user reports"
            ...
            RowLayout {
                ...
                SecondaryButton {
                    ...
                    onClicked: {
                        ...
                        // (QGuiApplication::clipboard()). from the server
            ...
            Card {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        width: parent.width
                        height: Math.max(0, _reportsPage.count) * Theme.size.tableRowHeight
                        clip: true
                        interactive: false
                        model: _reportsPage
                        spacing: 0
            ...
            EmptyState {
                width: parent.width
                height: _filteredReports.count === 0 ? 200 : 0
