            ...
            Item {
                ...
                Card {
                    ...
                    Column {
                        ...
                        Column {
                            ...
                            Grid {
                                ...
                                Repeater {
                                    ...
                                    delegate: GenreChip {
                                        label: modelData
                                        selected: root.viewModel && root.viewModel.selectedGenres ? root.viewModel.selectedGenres.indexOf(modelData) >= 0 : false
                            ...
                            Row {
                                ...
                                Column {
                                    ...
                                    Slider {
                                        ...
                                        onMoved: {
                                            if (root.viewModel) {
                                                // BUG FIX: clamp so min never exceeds max.
                                                root.viewModel.minPrice = Math.min(value, root.viewModel.maxPrice - 1)
                                                _priceDebounce.restart()
                                            }
                                        }
                                    }
                                }
                                ...
                                Column {
                                    ...
                                    Slider {
                                        ...
                                        onMoved: {
                                            if (root.viewModel) {
                                                // BUG FIX: clamp so max never drops below min.
                                                root.viewModel.maxPrice = Math.max(value, root.viewModel.minPrice + 1)
                                                _priceDebounce.restart()
                                            }
                                        }
                                    }
                        ...
                        // BUG FIX: debounce the search triggered by price-slider
                        // drags. Previously every onMoved fired a blocking search
                        // round-trip — dragging the slider triggered N searches.
                        // Now a 300ms timer collapses rapid drags into one search.
                        Timer {
                            id: _priceDebounce
                            interval: 300
                            repeat: false
                            onTriggered: if (root.viewModel) root.viewModel.search()
                        }
