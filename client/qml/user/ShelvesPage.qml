            ...
            Row {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        text: String(root.viewModel ? root.viewModel.count : 0)
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                BookRow {
                                    ...
                                    book: modelData
                                    showActions: false
                                    // v15f: hide the price — books in a
                                    // shelf are for organizing, not selling.
                                    showPrice: false
                                    onClicked: {
    ...
    Popup {
        ...
        Column {
            ...
            InputField {
                ...
                maximumLength: 50
                // Issue 3: sync the internal TextField's edits back to
                // _renameField.text. Without this, _renameField.text stays
                // pinned to the original name (set in openDialog) and the
                // rename button sends the OLD name to the server. This
                // matches the pattern used by other InputFields in the app.
                onTextEdited: function(newText) { _renameField.text = newText }
                onAccepted: {
    ...
    Popup {
        ...
        Column {
            ...
            SearchField {
                ...
                onTextEdited: function(newText) { _bookPicker._search = newText }
            }
            ...
            ScrollView {
                ...
                ListView {
                    ...
                    anchors.fill: parent
                    model: {
                        // v15g: use the user's PURCHASED library books (via
                        // LibraryService.purchasedBooks()) instead of
                        // BookService.bestsellers(). This connects shelves
                        // to the user's actual library — the user can only
                        // add books they own to a shelf.
                        const all = LibraryService.purchasedBooks() || []
