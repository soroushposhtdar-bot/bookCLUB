...
Item {
    ...
    Row {
        ...
        Rectangle {
            ...
            color: !root.enabled ? Qt.rgba(Theme.color.textMuted.r, Theme.color.textMuted.g, Theme.color.textMuted.b, 0.30)
            ...
            Rectangle {
                ...
                layer.effect: DropShadowBase {
                    colorSpec: { "color": Theme.shadow.sm.color, "blur": Theme.shadow.sm.blur, "offsetY": Theme.shadow.sm.offsetY }
                }
            }
        }
