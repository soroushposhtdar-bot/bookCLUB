...
private:
    ...
    // BUG FIX (Issue 38): re-entrancy guard for refresh(). Prevents
    // qDeleteAll on DTOs that QML may still be binding to when a real-
    // time booksChanged signal fires during a wave-2 window.
