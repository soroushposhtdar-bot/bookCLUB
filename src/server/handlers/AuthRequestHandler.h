...
private:
    ...
    void handleGetCurrentUser(const QJsonObject& payload, ClientConnection* client);
    void handleUpdateProfile(const QJsonObject& payload, ClientConnection* client);
    void handleSaveFavoriteGenres(const QJsonObject& payload, ClientConnection* client);
